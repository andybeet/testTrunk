...
printf("out\n");
                    ...
                    */
					...
					fflush(stdout);
					printf("Read in time series effort \n");
					printf("fishery number = %d\n",fishery_id);
					printf("box num = %d\n",ij);
					printf("&bm->tsEffort[ij] = %d\n",&bm->tsEffort[ij]);
