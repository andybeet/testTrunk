...
typedef struct {
	...
	int tracerID; /* link to the tracer in the model */
...
typedef struct {
	...
	PhyPropertyData *forceTracerInput;
	...
	int K_num_sexes;  /**< Number of sexes covered - TODO: Need to generalise
							code because at present effectively assumes 1 sex */
