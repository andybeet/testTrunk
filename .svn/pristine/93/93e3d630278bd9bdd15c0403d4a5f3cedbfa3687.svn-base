...
void Util_Setup_Species_Param_Strings(MSEBoxModel *bm) {
	...
	sprintf(paramStrings[num_migrate_id], "%s", "Migrate");
    sprintf(paramStrings[multiyr_mig_id], "%s", "MultiyrMigrate");
    sprintf(paramStrings[stagger_years_id], "%s", "StaggerYears");
    sprintf(paramStrings[flag_multiyr_type_id], "%s", "FlagMultiyrMigType_");
